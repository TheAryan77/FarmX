...
/**
 * Dense data table for the buyer / FPO / admin apps.
 *
...
function TableHead({ className, ...props }: React.ComponentProps<"th">) {
  return (
    <th
      ...
      className={cn(
        "text-muted-foreground h-9 px-3 text-left align-middle text-xs font-semibold tracking-wide uppercase whitespace-nowrap",
        className,
      )}
      {...props}
    />
